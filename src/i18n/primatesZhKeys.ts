export const primatesZhKeys = new Set<string>([
  ...
  "Not assessed in the selected habitat-use study.",
  "Not established by the selected one-site habitat-use study.",
  "A year of daily follows at Bossou sampled one local community, including 10 adult focal individuals. These observations do not establish species-wide habitat use or a current range-wide synthesis.",
  "African Apes",
  "Chimpanzees",
  "Chimpanzee",
  ...
  "Bridger Formation adapiform foot sample",
  "Bridger Formation",
  "Wyoming",
  "United States",
  "A semi-articulated Notharctus foot represented by AMNH 143612 and AMNH 143640 preserves ray-specific phalanges used to test the identity and function of a digit-two grooming claw; the specimen comparison is not a crown-primate or direct-ancestor claim.",
  "Diet is not directly recorded by the cited foot material",
  "Bridger Formation provenance does not establish habitual microhabitat",
  "Foot proportions permit functional comparison, but locomotor behaviour was not observed",
  "The cited study does not establish a population-wide body-size estimate",
  "Ecological guild remains unresolved from the foot anatomy",
  "Semi-articulated AMNH 143612 and AMNH 143640 foot",
  "Ray-specific proximal and intermediate phalanges",
  "Digit-two grooming-claw functional inference",
  "Maiolino and colleagues document the specimen association and phalangeal comparisons in e29135, Figures 3–10 and Table 2. The grooming-claw interpretation is a functional inference bounded to the named foot, not observed grooming behaviour or a universal primate condition.",
  "Eosimias (Shanghuang and Yuanqu tarsal sample)",
  "Middle Eocene isolated tarsal sample",
  "Shanghuang fissure fillings",
  "Yuanqu Basin",
  "China",
  "Isolated calcanei and tali from Shanghuang and Yuanqu were attributed to Eosimias and compared in a character matrix testing anthropoid affinity; they are not dentally associated skeletons, a direct ancestor, or a complete record of Eosimias anatomy.",
  "Diet is not directly recorded by the isolated tarsals",
  "Fissure-fill and basin provenance do not establish habitual habitat",
  "Tarsal form supports comparative locomotor interpretation, not observed behaviour",
  "Body-size reconstruction from isolated tarsals remains comparative",
  "Ecological guild is unresolved from the sampled ankle bones",
  "Isolated calcanei and tali",
  ...
  "Not assessed in the selected core studies.",
  "The Lake Manyara paper compares road-transect estimates with a sleeping-site-based upper limit; roads are a possible source of sampling bias, not a full habitat account.",
