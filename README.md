...
当前已发布数据快照为 `2026.08-static-v5-rc23`，开发中的 Web/移动客户端版本为 `0.18.0`。精确记录数、校验和和限制以 [`data/manifest.json`](data/manifest.json) 为准；科学内容变更见 [`data/CHANGELOG.md`](data/CHANGELOG.md)。
...
- 查看 232 个策展导航实体、24 个资源包及其实际科学成熟度。
