...
- **Synchronized Explorer** — Geological timeline, checksum-verified six-layer CAO2024 period-midpoint snapshots (coastlines, topological plates, typed boundaries, continental crust, continent–ocean boundaries and static reconstruction partitions), occurrence-coordinate map, tree of life, evidence inspector and dataset-checked shareable URL state. The three heavier technical layers are independently loaded only when requested.
