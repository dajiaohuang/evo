...
当前开发数据快照为 `2026.08-static-v5-rc56`，Web/Android/iOS 客户端版本为 `0.20.7`。精确记录数、校验和限制以 [`data/manifest.json`](data/manifest.json) 为准；科学内容变更见 [`data/CHANGELOG.md`](data/CHANGELOG.md)。
