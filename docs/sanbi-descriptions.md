...
The complete three-species accepted *Klattia* genus in COL26.8 is now mapped to individual SANBI *Strelitzia* 42 accounts: *K. partita* (COL `3R96F`, WFO `wfo-0000784551`, printed p.57), *K. flava* (`6NKCG`, `wfo-0000784557`, p.57), and *K. stokoei* (`3R96G`, `wfo-0000784550`, p.58). The 2020 book is all-rights-reserved, so dossiers paraphrase facts and do not redistribute its text or images. SANBI Red List pages provide national assessments, each with its assessment date kept distinct from the displayed dataset version: *K. partita* LC (2018-10-02), *K. flava* VU D1+2 (2007-07-28), and *K. stokoei* EN D (2007-07-28). These five facets have bounded regional/national evidence; evolution and fossils remain unassessed and none of the three records is complete. Sources: [*Strelitzia* 42](https://www.sanbi.org/wp-content/uploads/2024/05/2020_Strelitzia42.pdf), [SANBI Red List genus account](https://redlist.sanbi.org/genus.php?genus=1516), and the species pages for [*K. partita*](https://redlist.sanbi.org/species.php?species=1516-3), [*K. flava*](https://redlist.sanbi.org/species.php?species=1516-1), and [*K. stokoei*](https://redlist.sanbi.org/species.php?species=1516-4).
...
## Cyclopia individual species accounts (2026-09-24)

Five accepted Cyclopia species without an existing dossier were linked by their exact COL26.8 accepted names and authorships to the pinned WFO 2026-06 accepted-species crosswalk. Their SANBI e-Flora v1.36 source rows carry the same WFO identifiers, and the individual names and accounts were checked on p. 549 of Schutte's *Cyclopia* treatment in Strelitzia 29:

| COL ID / accepted name | WFO 2026-06 ID | SANBI archive rows (Morphology / Habitat) | Printed locator |
| --- | --- | --- | --- |
| `9D2C4` *Cyclopia alopecuroides* A.L.Schutte | `wfo-0000632109` | 5056 / 28482 | p. 549, individual account |
| `9D2C5` *C. alpina* A.L.Schutte | `wfo-0000632110` | 5055 / 28483 | p. 549, individual account |
| `32VQF` *C. aurescens* Kies | `wfo-0000197612` | 5059 / 28484 | p. 549, individual account |
| `32VQG` *C. bolusii* Hofmeyr & E.Phillips | `wfo-0000197623` | 5039 / 28485 | p. 549, individual account |
| `32VQH` *C. bowieana* Harv. | `wfo-0000197634` | 5040 / 28486 | p. 549, individual account |

The dossiers paraphrase only the individual accounts' basic form/leaf traits, flowering periods, habitat/elevation and regional range summaries. Those four facets remain `partially-supported`; evolution, fossil and conservation are `not-assessed`. All five records are explicitly `incomplete`, have untranslated English claims, and have no external expert review. The SANBI archive EML's CC BY 4.0 declaration is recorded only for the archive. Separately, the item-level SANBI Opus record for Strelitzia 29 states CC BY-SA 4.0; only that book-specific license supports the paraphrased claims. No book text or images are redistributed. See the five-record source file and compressed shard in `data/knowledge/` and their checksums in `catalogue-dossier-shards.json`.
