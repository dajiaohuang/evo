# WoRMS Oligochaeta archive projection (1099)

This source-specific projection freezes ChecklistBank dataset 1099, “World
List of Marine Oligochaeta”, version 2026-09-01, version DOI `10.48580/d3bx.v85`.
The committed official `/archive` bytes are 59,152 with SHA-256
`41a1388a97e661d8c749cfc5c04ced11eacf415aca56fa07f0279a7f5bcf7cdc`.
The source metadata records the licence as `cc by`, the archive locator as
`https://api.checklistbank.org/dataset/1099/archive`, and the source landing
URL as `https://www.marinespecies.org`.

The COL boundary is the exact accepted-species closure below root usage
`B8W74` (Oligochaeta Grube, 1850) for source dataset 1099. It contains 4,403 COL species and
