...
This document records the authority boundary for the COL26.8 package. It combines the existing World Foraminifera Database identifier layer with 25 disjoint ITIS scope audits derived from the official `itisSqlite082626` export dated 2026-08-26.
...
The 25 ITIS scopes contain 19,575 native records: 12,824 COL rows and 6,751 current ITIS-only rows. COL outcomes are 1,481 accepted mappings, 9 redirects that follow an official ITIS synonym relationship, no ambiguities, and 11,334 unmatched names. Four accepted Ochrophyta mappings use frozen COL `name.link` TSNs to select direct accepted-name candidates; they are not contributor-source relations. The 12,824 COL usage IDs are disjoint across all scopes.
...
| Ochrophyta | 1,101 | 1,101 | 0 | 0 | 0 | 2,298 | 2 |
| Amoebozoa | 1,337 | 0 | 0 | 0 | 1,337 | 0 | 1 |
| Rhodophyta | 0 | 0 | 0 | 0 | 0 | 1,616 | 1 |
| Oomycota shared-order boundary | 1,494 | 53 | 1 | 0 | 1,440 | 42 | 2 |
...
| **Total** | **12,824** | **1,481** | **9** | **0** | **11,334** | **6,751** | **19** |
