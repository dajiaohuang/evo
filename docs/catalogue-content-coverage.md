...
截至 2026-09-25 的当前覆盖计数（固定 COL26.8）：层级索引覆盖 2,183,133 个接受种；来源原文关联 80,838 种；有来源双语入门概述 55 种。档案分片索引列出 59 个分片，共 6,957 条唯一种级档案记录；逐片校验的行数及压缩/解压 SHA-256 均与索引一致。6,957 条均为 incomplete、均为 not-reviewed；完整科学档案为 0，外部领域专家评审为 0。七主题状态计数如下（未列状态为 0）：形态 partial 6,895、not-assessed 62；生活史 partial 183、not-assessed 6,774；生态 partial 6,926、not-assessed 31；演化 partial 54、not-assessed 6,903；分布 partial 204、not-assessed 6,753；化石 partial 1、not-assessed 6,956；保育 partial 31、not-assessed 6,926。另有 2,176,176 个接受种没有档案记录。本批新增 *Parus major*、*Hyla arborea* 与 *Sparisoma aurofrenatum* 三条来源限定档案，分别涉及采后手持测试中的雄鸟啄击反应、野生雄蛙补充喂食实验中的鸣叫率、以及康奇礁围笼内新基质的藻类演替。此前批次中的 *Apis mellifera* 只涉及管理蜂群舞蹈实验，*Aplysia californica* 只涉及一个圈养队列的体重和存活观察，*Solanum lycopersicum* 只涉及一种撒丁岛栽培品种的冷藏果实硬度；这些都不是全种结论。以上档案仍不完整，档案数和 partial 主题都不表示完整科学覆盖；权威身份集合见[档案分片索引](../data/knowledge/catalogue-dossier-shards.json)。新增 Cyclopia 档案的物种清单及定位见 [SANBI 来源记录](sanbi-descriptions.md#cyclopia-individual-species-accounts)。
