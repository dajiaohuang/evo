...
35. 新增三个跨类群 COL26.8 种级证据切片：辐鳍鱼 *Gasterosteus aculeatus*（`3FCKT`）、灵长类 *Saimiri boliviensis*（`4TZJS`）和两栖类 *Rana temporaria*（`6WR99`）。分别以 CC BY 4.0 PLOS 胚胎研究、CC BY 3.0 PeerJ 圈养社会学习实验和 CC BY 4.0 野外繁殖物候研究支持限定主张；记录精确接受用法及父链、原文段落/图表定位、地区/时间/野外或圈养范围及逐项许可。三份档案均 incomplete、not-reviewed；未证主题明确保持 not-assessed。此批不修改 App/GitHub Pages 共用核心选择清单。
36. 新增三个跨类群 COL26.8 种级证据切片：西方蜜蜂 *Apis mellifera*（`FN46`）、加州海兔 *Aplysia californica*（`FQ2Y`）和番茄 *Solanum lycopersicum*（`4Y369`）。分别记录 CC BY 4.0 PNAS 管理蜂群舞蹈实验、CC BY 4.0 Frontiers 单一圈养队列体重/存活资料、CC BY 4.0 PLOS 撒丁岛栽培品种果实硬度研究；每项均附固定接受身份及父链、段落/图表定位、地域/时间/野生/栽培或圈养范围和许可。新证据只支持限定主题，其他主题保持 not-assessed；三份档案均 incomplete、not-reviewed。本批不扩充 App 与 Pages 共用的五包核心清单，也不把完整档案分片打入预览包。
...
截至 2026-09-25 的当前覆盖计数（固定 COL26.8）：层级索引覆盖 2,183,133 个接受种；来源原文关联 80,838 种；有来源双语入门概述 55 种。档案分片索引列出 63 个分片，共 6,969 条唯一种级档案记录；逐片校验的行数及压缩/解压 SHA-256 均与索引一致。6,969 条均为 incomplete、均为 not-reviewed；完整科学档案为 0，外部领域专家评审为 0。七主题状态计数如下（未列状态为 0）：形态 partial 6,898、not-assessed 71；生活史 partial 186、not-assessed 6,783；生态 partial 6,935、not-assessed 34；演化 partial 55、not-assessed 6,914；分布 partial 207、not-assessed 6,762；化石 partial 1、searched-no-evidence 1、not-assessed 6,967；保育 partial 31、not-assessed 6,938。另有 2,176,164 个接受种没有档案记录。第35批新增 *Parus major*、*Hyla arborea* 与 *Sparisoma aurofrenatum* 三条来源限定档案，分别涉及采后手持测试中的雄鸟啄击反应、野生雄蛙补充喂食实验中的鸣叫率、以及康奇礁围笼内新基质的藻类演替。第36批新增 *Triticum aestivum*、*Candida albicans* 与 *Octopus vulgaris* 三条来源限定档案，分别记录南埃塞俄比亚一个雨养小麦试验中的产量比较、化疗小鼠模型中的白色念珠菌与舌部细菌负荷关系，以及普通章鱼不同圈养饲料组的繁殖差异；这些结论均限定于各自研究样本和条件。此前批次中的 *Apis mellifera* 只涉及管理蜂群舞蹈实验，*Aplysia californica* 只涉及一个圈养队列的体重和存活观察，*Solanum lycopersicum* 只涉及一种撒丁岛栽培品种的冷藏果实硬度；这些都不是全种结论。以上档案仍不完整，档案数和 partial 主题都不表示完整科学覆盖；权威身份集合见[档案分片索引](../data/knowledge/catalogue-dossier-shards.json)。新增 Cyclopia 档案的物种清单及定位见 [SANBI 来源记录](sanbi-descriptions.md#cyclopia-individual-species-accounts)。 第37批新增 *Pleurotus ostreatus* (4KF6G)、*Penaeus vannamei* (9XW87) 和灵长目的滇金丝猴 *Rhinopithecus bieti* (4S9ML) 三条部分支持档案；主张限于各自单项研究，其他主题保持 not-assessed，App 与 Pages 精选范围未改变。批次输入、可重复生成器和分片摘要见 [Batch 37 manifest](../data/knowledge/species-evidence-batch37-2026-09-25.batch-manifest.json)。

第38批新增 *Chelonia mydas* (TVGD)、*Glycine max* (3GF5W) 与 *Pleurotus pulmonarius* (4KF7P) 三条部分支持档案：玫瑰环礁 2012–2019 年快速调查至少确认 138 只不同的筑巢绿海龟；巴西戈亚斯一块大豆田 2019/2020 夏季的对照与 SAF9 产量比较；以及 Hangxiu 1 菌株山茶壳基质试验的蘑菇总产量。每条主张均限定于来源中的地点、时间、种群或栽培条件，其他主题保持 not-assessed。批次只扩充 canonical 全物种档案，不改变 App 与 GitHub Pages 共用的精选核心清单。输入、可重复生成器和分片摘要见 [Batch 38 manifest](../data/knowledge/species-evidence-batch38-2026-09-25.batch-manifest.json)。

第39批新增灵长目的川金丝猴 *Rhinopithecus roxellana* (4S9MN)、咖啡 *Coffea arabica* (WVWV) 和海参 *Holothuria scabra* (6LZDS) 三条部分支持档案：四川 2001–2023 年区域分布综合、越南山罗省成年栽培咖啡减雨田间试验，以及巴布亚新几内亚海草围栏中人工孵化幼参的首次回收。所有主张均限定于来源中的地域、时期和研究/栽培条件，未评估主题保持 not-assessed。灵长目既有核心内容清单未改变；本批全物种档案仍只进 canonical/Web 侧。批次输入、可重复生成器和分片摘要见 [Batch 39 manifest](../data/knowledge/species-evidence-batch39-2026-09-25.batch-manifest.json)。

第40批没有新增索引物种；为核心预览导航已有的 *Callithrix jacchus*（COL26.8 `697NS`）扩充既有逐种档案。四篇逐项核验 CC BY 4.0 的论文为形态、圈养辅助生殖、巴西狂犬病监测/人兽病原关系、线粒体亲缘研究提供了限定主张；化石主题新增两条 PBDB 名称查询与定向文献检索的“限定检索未发现”结果。五个主题仍为 partially-supported，化石为 searched-no-evidence，保育仍 not-assessed；旧生活史主张的“译文未核验”状态保持不变，所以此档案仍 incomplete、未外审。App 与 GitHub Pages 共用的精选核心清单未改变；完整物种档案只留在 canonical/Web 侧。输入、可重复生成器和分片摘要见 [Batch 40 manifest](../data/knowledge/primates-callithrix-jacchus-evidence-expansion-b40-2026-09-25.batch-manifest.json)。

第41批没有新增索引物种；原位扩充重点物种 *Pan troglodytes*（COL26.8 `4C92G`）的既有档案。新增圈养群体体重/生长、贡贝野生雌性成熟史，以及 2016 年 IUCN 物种分布和濒危类别快照；每项保留圈养/野生边界、样本地点与评估年代，旧评估不宣称为当前状态。七主题中形态、生活史、生态、演化、分布、保育均为 partially-supported，化石保持 not-assessed；条目仍 incomplete、未外审。化石属级记录未提升为种级证据。App 与 GitHub Pages 继续共用同一精选核心内容，预览重点仍包含灵长目；全量档案不进入 App/Pages 包。输入、原位生成器和分片摘要见 [Batch 41 manifest](../data/knowledge/primates-pan-troglodytes-facets-b41-2026-09-25.batch-manifest.json)。
