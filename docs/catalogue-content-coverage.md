...
RC156 / COL26.8（2026-08-20）。分类、来源原文、来源字段标签、入门概述、完整档案与专家评审分别计量，不能互相替代。
...
当前 55 条概述属于有来源的入门介绍，尚不是完整生活史、系统发育、化石、性状、分布、保育与媒体档案。逐主题档案目前有红狐与 `Ctenium concinnum` 共 2 种；后者仅形态、生态部分支持，其余未评估。完整档案与外部领域专家评审仍为 0。
