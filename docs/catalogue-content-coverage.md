...
截至 2026-09-25 的当前覆盖计数（固定 COL26.8）：层级索引覆盖 2,183,133 个接受种；来源原文关联 80,838 种；有来源双语入门概述 55 种。档案分片索引列出 60 个分片，共 6,960 条唯一种级档案记录；逐片校验的行数及压缩/解压 SHA-256 均与索引一致。6,960 条均为 incomplete、均为 not-reviewed；完整科学档案为 0，外部领域专家评审为 0。七主题状态计数如下（未列状态为 0）：形态 partial 6,895、not-assessed 65；生活史 partial 184、not-assessed 6,776；生态 partial 6,928、not-assessed 32；演化 partial 54、not-assessed 6,906；分布 partial 204、not-assessed 6,756；化石 partial 1、not-assessed 6,959；保育 partial 31、not-assessed 6,929。另有 2,176,173 个接受种没有档案记录。第35批新增 *Parus major*、*Hyla arborea* 与 *Sparisoma aurofrenatum* 三条来源限定档案，分别涉及采后手持测试中的雄鸟啄击反应、野生雄蛙补充喂食实验中的鸣叫率、以及康奇礁围笼内新基质的藻类演替。第36批新增 *Triticum aestivum*、*Candida albicans* 与 *Octopus vulgaris* 三条来源限定档案，分别记录南埃塞俄比亚一个雨养小麦试验中的产量比较、化疗小鼠模型中的白色念珠菌与舌部细菌负荷关系，以及普通章鱼不同圈养饲料组的繁殖差异；这些结论均限定于各自研究样本和条件。此前批次中的 *Apis mellifera* 只涉及管理蜂群舞蹈实验，*Aplysia californica* 只涉及一个圈养队列的体重和存活观察，*Solanum lycopersicum* 只涉及一种撒丁岛栽培品种的冷藏果实硬度；这些都不是全种结论。以上档案仍不完整，档案数和 partial 主题都不表示完整科学覆盖；权威身份集合见[档案分片索引](../data/knowledge/catalogue-dossier-shards.json)。新增 Cyclopia 档案的物种清单及定位见 [SANBI 来源记录](sanbi-descriptions.md#cyclopia-individual-species-accounts)。
