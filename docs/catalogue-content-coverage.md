...
当前覆盖计数（固定 COL26.8）：层级索引覆盖 2,183,133 个接受种；来源原文关联 80,838 种；有来源双语入门概述 55 种；校验分片中有逐项主题档案 6,841 份。档案分片包括原有 3,841 份及 SANBI 批次 3,000 份；新增批次的形态与生态为部分支持，其余五主题未评估。全部 6,841 份目前均不完整，完整科学档案 0，外部领域专家评审 0。数字分别对应目录节点、来源文本、入门概述和部分证据档案，互不替代。
