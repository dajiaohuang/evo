...
This projection freezes ChecklistBank dataset 1127, World List of Cestoda (2026-09-01). The pinned API metadata reports DOI `10.48580/d3cw`, version DOI `10.48580/d3cw.v84`, and license `cc by`; the archive's own `metadata.yml` reports DOI `null` and license `CC-BY`. Both metadata layers and their hashes are retained separately without inferring a Creative Commons version. The repository archive is `data/sources/archives/checklistbank-1127-cestoda-2026-09-01.zip`, 658,677 bytes, SHA-256 `f6deb567467713931bcca73f234f2d61f63d996f65bf3c0f271f188a352b1ee8`.
