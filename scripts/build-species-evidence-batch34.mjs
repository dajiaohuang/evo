...
const INPUT = 'data/sources/species-evidence-batch34-2026-09-25.json'
const OUTPUT = 'data/knowledge/species-evidence-batch34-2026-09-25.batch-manifest.json'
const NEW_RAW = 'data/knowledge/raw-dossiers/species-evidence-batch34-2026-09-25.jsonl'
const NEW_SHARD = 'data/knowledge/catalogue-dossiers-species-evidence-batch34-2026-09-25.jsonl.br'
...
const EXPECTED_INPUT_SHA256 = 'f3c9349d20f119f46d948836ed951a163b9a63f65d4d94a488085c7d07996925'
...
assert.equal(input.batchId, 'species-evidence-batch34-2026-09-25')
assert.equal(input.releaseAlias, 'COL26.8')
assert.equal(input.baseAudit.indexedRecordCount, 6951)
assert.equal(input.baseAudit.indexedShardCount, 57)
  ...
  if (!alreadyApplied) {
    ...
    for (const update of input.updates.filter(item => item.targetShardPath === targetShard)) {
      ...
      const supplement = {
        ...
        generator: 'scripts/build-species-evidence-batch34.mjs',
