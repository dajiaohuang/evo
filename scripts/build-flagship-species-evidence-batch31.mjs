...
const SOURCE = 'data/sources/flagship-species-evidence-batch31-2026-09-25.json'
const RAW = 'data/knowledge/raw-dossiers/flagship-species-evidence-batch31-2026-09-25.jsonl'
const SHARD = 'data/knowledge/catalogue-dossiers-flagship-species-evidence-batch31-2026-09-25.jsonl.br'
const BATCH_MANIFEST = 'data/knowledge/flagship-species-evidence-batch31-2026-09-25.batch-manifest.json'
...
const EXPECTED_BASE_HEAD = '7be16e928d31d9883e2b3377b69d8ec55f501781'
const EXPECTED_BASE_RECORDS = 6941
const FACETS = ['morphology', 'lifeHistory', 'ecology', 'evolution', 'distribution', 'fossil', 'conservation']
const TARGETS = new Map([
  ['FN46', { scientificName: 'Apis mellifera Linnaeus, 1758', authorship: 'Linnaeus, 1758', sourceDatasetId: '2144' }],
  ['FQ2Y', { scientificName: 'Aplysia californica J. G. Cooper, 1863', authorship: 'J. G. Cooper, 1863', sourceDatasetId: '1130' }],
  ['4Y369', { scientificName: 'Solanum lycopersicum L.', authorship: 'L.', sourceDatasetId: '1141' }],
])
...
assert.equal(source.batchId, 'flagship-species-evidence-batch31-2026-09-25')
...
const batchManifest = {
  ...
  generator: 'scripts/build-flagship-species-evidence-batch31.mjs',
}
