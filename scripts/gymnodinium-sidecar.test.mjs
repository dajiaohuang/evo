...
describe('ChecklistBank 1177 Gymnodinium sidecar', () => {
  it('preserves the exact source boundary and leaves the spelling difference unmatched', () => {
    ...
    expect(upstream).toMatchObject([{ sourceAcceptedTaxonId: 'T284', status: 'source-only', matchedName: { id: 'T284', scientificName: 'Gymnodinium p.dorhni' }, acceptedName: null, candidates: [], sourceAcceptedRecord: { SpeciesEpithet: 'p.dorhni' } }])
