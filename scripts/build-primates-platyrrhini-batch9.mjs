...
const SOURCE_PATH = join(ROOT, 'data', 'sources', 'primates-platyrrhini-batch9-2026-09-24.json')
const RAW_PATH = join(ROOT, 'data', 'knowledge', 'raw-dossiers', 'primates-platyrrhini-batch9-2026-09-24.jsonl')
const SHARD_PATH = join(ROOT, 'data', 'knowledge', 'catalogue-dossiers-primates-platyrrhini-batch9-2026-09-24.jsonl.br')
const MANIFEST_PATH = join(ROOT, 'data', 'knowledge', 'catalogue-dossiers-primates-platyrrhini-batch9-2026-09-24.batch-manifest.json')
...
const EXPECTED_SOURCE_SHA256 = 'ce51777f4dfdffb33245253701d5e71a412e54608d9a7a76716468433c5717a1'
...
const manifest = {
  ...
  generator: 'scripts/build-primates-platyrrhini-batch9.mjs',
}
