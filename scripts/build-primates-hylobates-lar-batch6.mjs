...
const SOURCE_PATH = join(ROOT, 'data', 'sources', 'primates-hylobates-lar-batch6-2026-09-24.json')
const RAW_PATH = join(ROOT, 'data', 'knowledge', 'raw-dossiers', 'primates-hylobates-lar-batch6-2026-09-24.jsonl')
const SHARD_PATH = join(ROOT, 'data', 'knowledge', 'catalogue-dossiers-primates-hylobates-lar-batch6-2026-09-24.jsonl.br')
const MANIFEST_PATH = join(ROOT, 'data', 'knowledge', 'catalogue-dossiers-primates-hylobates-lar-batch6-2026-09-24.batch-manifest.json')
const REGISTRY_ROOT = join(ROOT, 'data', 'catalogue-of-life', 'releases', '2026-08-20', 'registry')
const FACETS = ['morphology', 'lifeHistory', 'ecology', 'evolution', 'distribution', 'fossil', 'conservation']
const EXPECTED_SOURCE_SHA256 = '9733a1a9e2c04b58380fb9947318b2fcfbef0b5f0799e917c09fde25929edfe8'
...
const manifest = {
  ...
  generator: 'scripts/build-primates-hylobates-lar-batch6.mjs',
}
