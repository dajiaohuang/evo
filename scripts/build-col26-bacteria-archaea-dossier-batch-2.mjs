...
function makeRecord(t) {
  ...
  return {
    colId: t.colId, scientificName: t.name, rank: 'species', sourceDatasetId: t.sourceDatasetId, checkedAt: batch.checkedAt,
    identity: { method: `Exact COL26.8 usage ${t.colId} checked for full name ${t.name}, authorship ${t.authorship}, species rank, accepted status and sourceDatasetId ${t.sourceDatasetId}; pinned LPSN crosswalk maps this COL ID to record ${t.lpsnId}.`, scope: 'Nomenclatural usage crosswalk only; no complete biological species-concept equivalence inferred.', sourceIds: ['col', 'lpsn'] },
