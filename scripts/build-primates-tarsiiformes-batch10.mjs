...
const SOURCE_PATH = join(ROOT, 'data', 'sources', 'primates-tarsiiformes-batch10-2026-09-24.json')
const RAW_PATH = join(ROOT, 'data', 'knowledge', 'raw-dossiers', 'primates-tarsiiformes-batch10-2026-09-24.jsonl')
const SHARD_PATH = join(ROOT, 'data', 'knowledge', 'catalogue-dossiers-primates-tarsiiformes-batch10-2026-09-24.jsonl.br')
const MANIFEST_PATH = join(ROOT, 'data', 'knowledge', 'catalogue-dossiers-primates-tarsiiformes-batch10-2026-09-24.batch-manifest.json')
...
const EXPECTED_SOURCE_SHA256 = '5029877eb74fbc428889bc3c2a7bed16e9425eb92ebe1a318e27816adfa66f4f'
...
const manifest = {
  ...
  generator: 'scripts/build-primates-tarsiiformes-batch10.mjs',
}
