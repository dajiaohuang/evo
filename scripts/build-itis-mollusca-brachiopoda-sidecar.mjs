...
const COL_ROOTS = [
  ...
  { id: 'KZ', scientificName: 'Graptolithina Bronn, 1849', itisScientificName: 'Graptolithina', role: 'applicable', itisTsn: 993363, itisRank: 'Subclass' },
]
...
async function main() {
  ...
  const sidecar = {
    ...
    evidenceBoundary: { en: 'This CC0 ITIS sidecar supplies a frozen, exact nomenclatural crosswalk only for the declared Mollusca, Brachiopoda and Graptolithina COL roots. The Graptolithina comparison is a name-only closure for the package’s seven represented Rhabdopleura species; it makes no molluscan or brachiopod affinity claim. It is not a final classification authority, phylogeny, species-concept equivalence assertion, biological dossier, or scientific-review record.', zh: '此 CC0 ITIS 侧车仅为所声明的软体动物、腕足动物和笔石亚纲 COL 根提供冻结的严格命名交叉映射。笔石亚纲比较仅为该包所代表的七个 Rhabdopleura 物种提供名称闭合，不主张其属于软体动物或腕足动物。它不是最终分类权威、系统发育树、物种概念等同性声明、生物档案或科学审查记录。' },
