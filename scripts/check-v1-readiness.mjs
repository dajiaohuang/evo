...
const gates = [
  ...
  gate('entity-dossiers', '189/189 entities expose standard dossiers', dossierEntities.length === entities.length && entities.length === 189, `${dossierEntities.length}/${entities.length}`, 'Registry-only entries do not satisfy this gate.'),
