...
if (researchExampleCount !== 238 || researchExampleAvailableCount !== 238 || researchClaimLinkCount !== 358) failures.push(`research scene totals are ${researchExampleCount} examples, ${researchExampleAvailableCount} available-with-limitations and ${researchClaimLinkCount} claim links; expected 238/238/358`)
