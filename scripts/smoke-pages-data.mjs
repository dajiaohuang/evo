...
if (researchExampleCount !== 72 || researchExampleAvailableCount !== 72 || researchClaimLinkCount !== 105) failures.push(`research scene totals are ${researchExampleCount} examples, ${researchExampleAvailableCount} available-with-limitations and ${researchClaimLinkCount} claim links; expected 72/72/105`)
