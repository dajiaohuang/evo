...
if (researchExampleCount !== 167 || researchExampleAvailableCount !== 167 || researchClaimLinkCount !== 227) failures.push(`research scene totals are ${researchExampleCount} examples, ${researchExampleAvailableCount} available-with-limitations and ${researchClaimLinkCount} claim links; expected 167/167/227`)
