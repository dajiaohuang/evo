...
if (researchExampleCount !== 203 || researchExampleAvailableCount !== 203 || researchClaimLinkCount !== 288) failures.push(`research scene totals are ${researchExampleCount} examples, ${researchExampleAvailableCount} available-with-limitations and ${researchClaimLinkCount} claim links; expected 203/203/288`)
