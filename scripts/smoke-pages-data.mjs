...
if (researchExampleCount !== 185 || researchExampleAvailableCount !== 185 || researchClaimLinkCount !== 260) failures.push(`research scene totals are ${researchExampleCount} examples, ${researchExampleAvailableCount} available-with-limitations and ${researchClaimLinkCount} claim links; expected 185/185/260`)
