...
if (researchExampleCount !== 147 || researchExampleAvailableCount !== 147 || researchClaimLinkCount !== 201) failures.push(`research scene totals are ${researchExampleCount} examples, ${researchExampleAvailableCount} available-with-limitations and ${researchClaimLinkCount} claim links; expected 147/147/201`)
