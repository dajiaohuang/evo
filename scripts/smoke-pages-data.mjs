...
if (catalogue.resourcePacks?.packageCount !== 7
  ...
  for (const packageId of expectedResourcePackIds) {
    ...
    if (expectedLpsn) {
      ...
      if (extensions.length !== 39 || manifestFile.extensionFileCount !== 0 || manifestFile.canonicalExtensionFileCount !== 179) {
        failures.push('other-animals: Pages must publish all 39 authority summaries and no row shards')
      }
