...
if (researchExampleCount !== 130 || researchExampleAvailableCount !== 130 || researchClaimLinkCount !== 184) failures.push(`research scene totals are ${researchExampleCount} examples, ${researchExampleAvailableCount} available-with-limitations and ${researchClaimLinkCount} claim links; expected 130/130/184`)
