...
def source_obj(n,t): return {'id':n['ID'],'scientificName':n.get('scientificName'),'authorship':n.get('authorship'),'rank':n.get('rank'),'status':'accepted','link':n.get('link') or t.get('link') or ''}
...
def main():
    ...
    raw=a.archive.read_bytes(); metadata=a.metadata.read_bytes()
