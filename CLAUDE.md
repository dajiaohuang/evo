...
- `data/phylogenies/perissodactyla-hypothesis.json` is the scoped flagship topology. Its branch lengths do not encode time.
...
- Large fossil/GeoJSON chunks load on demand and are runtime-cached; do not add them to the PWA precache.
